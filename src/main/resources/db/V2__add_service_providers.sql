...
-- =====================
-- 0. Ensure update_updated_at function exists (Hibernate ddl-auto skips it)
-- =====================
...
CREATE INDEX IF NOT EXISTS idx_providers_shop ON service_providers(shop_id);
CREATE INDEX IF NOT EXISTS idx_providers_user ON service_providers(user_id);
CREATE INDEX IF NOT EXISTS idx_providers_shop_active ON service_providers(shop_id, is_active);

CREATE OR REPLACE TRIGGER service_providers_updated_at
